...
public record ApiResponse<T>(int code, T data, String message) {
     ...
     * @param <T>  数据类型
     * @return code=200、message="请求成功" 的 ApiResponse
     */
     ...
     *
     * @param <T> 数据类型
     * @return code=200、data=null 的 ApiResponse
     */
     ...
     * @param message 错误信息
     * @param <T>     数据类型
     * @return data=null 的 ApiResponse
     */
