...
class CNN_2_Standalone(nn.Module):
    def __init__(self, in_channels=3, n_kernels=16, out_dim=10, input_size=32):
        super(CNN_2_Standalone, self).__init__()
...
class CNN_3_Standalone(nn.Module):
    def __init__(self, in_channels=3, n_kernels=16, out_dim=10, input_size=32):
        super(CNN_3_Standalone, self).__init__()
...
class CNN_4_Standalone(nn.Module):
    def __init__(self, in_channels=3, n_kernels=16, out_dim=10, input_size=32):
        super(CNN_4_Standalone, self).__init__()
...
class CNN_5_Standalone(nn.Module):
    def __init__(self, in_channels=3, n_kernels=16, out_dim=10, input_size=32):
        super(CNN_5_Standalone, self).__init__()
